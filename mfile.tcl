...
proc makemfilemenu {} {
	...
	.f1.f1.mb2.m1.c1 add cascade -menu .f1.f1.mb2.m1.c1.atmegal1 \
	    -label "ATmegaL1" -underline 2
	.f1.f1.mb2.m1.c1 add cascade -menu .f1.f1.mb2.m1.c1.atmegal2 \
	    -label "ATmegaL2" -underline 7
	.f1.f1.mb2.m1.c1 add cascade -menu .f1.f1.mb2.m1.c1.atmegal3 \
	    -label "ATmegaL3" -underline 7
	...
	menu .f1.f1.mb2.m1.c1.atmegal1 -tearoff 0
	menu .f1.f1.mb2.m1.c1.atmegal2 -tearoff 0
	menu .f1.f1.mb2.m1.c1.atmegal3 -tearoff 0
	...
	foreach m $devicelist {
		...
		atmega[1|2].* {
		    .f1.f1.mb2.m1.c1.atmegal1 add radiobutton -variable mcutype \
			-label $mcu -command setmcu
		}
		atmega[3|4].* {
		    .f1.f1.mb2.m1.c1.atmegal2 add radiobutton -variable mcutype \
			-label $mcu -command setmcu
		}
		atmega.* {
		    .f1.f1.mb2.m1.c1.atmegal3 add radiobutton -variable mcutype \
			-label $mcu -command setmcu
		}
		attiny.* {
